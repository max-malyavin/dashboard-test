...
const Input = ({ countTests = 0, inputValue, onChangeInput }) => {
  const handlerOnChange = (e) => onChangeInput(e.target.value);

  return (
    <React.Fragment>
      <div className="input-wrapper">
        <span className="input-suffix-search">
          <svg
            width="13"
            height="14"
            viewBox="0 0 13 14"
        ...
        />
        <span className="input-suffix-info ">{countTests} tests</span>
      </div>
    </React.Fragment>
  );
};
